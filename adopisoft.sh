...
wget -O adopisoft-5.0.0-amd64-node-v16.4.0.deb https://github.com/AdoPiSoft/Releases/releases/download/v5.0.0/adopisoft-5.0.0-amd64-node-v16.4.0.deb
sudo apt-get install ./adopisoft-5.0.0-amd64-node-v16.4.0.deb
#wget -O adopisoft-5.1.1-arm64-node-v16.4.0.deb https://github.com/AdoPiSoft/Releases/releases/download/v5.1.1/adopisoft-5.1.1-arm64-node-v16.4.0.deb
#sudo apt-get install ./adopisoft-5.1.1-arm64-node-v16.4.0.deb
